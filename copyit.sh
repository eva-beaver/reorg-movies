...
# This script will copy all movies from one directory to another.
#
...
#
#                      $1                                 $2                       $3 
# ./copyit.sh /mnt/share/allmovies/Alphabetical/X     /media/eva/Movie-Backup-1    X
# ./copyit.sh /mnt/share/movies/2020-11-November-1/   /media/eva/MovieWork/        20111
